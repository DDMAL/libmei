...
from pymei.exceptions import VersionMismatchException, NoVersionFoundException, MalformedXMLException, MeiException
...
class XmlImportTest(unittest.TestCase):
    ...
    #     doc = documentFromFile(os.path.join("test", "testdocs", "test-procinst.mei"), procinst)
    ...
    #         documentFromFile(os.path.join("test", "testdocs", "badversion.mei"))
